...
**사람을 주식처럼.**  
친구의 할 일에 투자하고, 성공/실패에 베팅하고, 실시간 주가를 보는 소셜 투두·경제 앱입니다.

우리 앱은 **“사람 = 한 종목”**입니다. 각자 오늘의 할 일을 상장하고, 친구는 그 사람 주식을 사거나 “이 할 일 성공할까?”에 베팅합니다. 할 일 완료율에 따라 **내 주가**가 오르내리며, 총 자산·랭킹·투자 손익이 모두 이 숫자들로 계산됩니다.
